            ...
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-friends" width="68" height="68" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <h4><span>1. </span>Choose Character</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Choose  Food</h4> </div>
              
                        <div class="step-item step3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-receipt" width="68" height="68" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16l-3 -2l-2 2l-2 -2l-2 2l-2 -2l-3 2m4 -14h6m-6 4h6m-2 4h2" />
                        </svg>
                            <h4><span>3. </span>Order and Pay!!</h4> </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from a sitcom friends</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
      ...
      <div class="col">
        <div class="col-10 mx-auto col-md-6 my-5">
          ...
          <p>Theme based restaurant based on a popular american sitcom FRIENDS.</p> 
          <p>We serve the all varity of dishes based on the charcaters favourite food.</p>
          <a href="#" class="btn theme-btn-dash pull-left ">explore</a>
