                                    ...
                                    <div class="payment-option">
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                ...
                                                <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Card <img src="images/paypal.jpg" alt="" width="90"></span> </label>
                                            </li>
                                        </ul>
